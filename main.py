                ...
                for tx in transactions:
                    ...
                    if tx_hash not in latest_tx_hashes and tx_time > last_run_time:
                        if tx['to'].lower() == wallet_address.lower():
                            ...
                            message = f'Incoming tx on {wallet_address}'
...
Don't forget to star my Github repo if you find this bot useful! https://github.com/cankatx/crypto-wallet-tracker â­ï¸
    """
